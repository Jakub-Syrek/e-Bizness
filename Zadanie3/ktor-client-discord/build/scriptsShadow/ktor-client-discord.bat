...
set CLASSPATH=%APP_HOME%\lib\ktor-client-discord-all.jar

@rem Execute ktor-client-discord
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KTOR_CLIENT_DISCORD_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%KTOR_CLIENT_DISCORD_EXIT_CONSOLE%" exit 1
exit /b 1
